...
export default function HomePage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-background font-paragraph text-secondary overflow-clip selection:bg-primary selection:text-primary-foreground">
      ...
      <section ref={heroRef} className="relative w-full h-[95vh] min-h-[800px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[120rem] mx-auto px-6 md:px-12 lg:px-20 pointer-events-none">
          <motion.div
          ...
          >
            ...
            <div className="p-10 md:p-14 flex flex-col gap-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-primary font-semibold tracking-widest uppercase text-sm">The Lifeline Project</span>
              </div>
              
              <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl leading-[1.1] text-secondary">
                Blood Bridge: <br />
                <span className="italic text-primary">Connecting</span> Life to Life
              </h1>
              
              <p className="text-lg md:text-xl text-secondary/80 leading-relaxed max-w-lg">
      ...
      <section className="py-32 px-6 md:px-12 lg:px-20 max-w-[120rem] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-4 sticky top-32">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-3 h-3 rounded-full bg-primary" />
              <span className="text-sm font-bold tracking-widest uppercase text-secondary/60">Our Mission</span>
            </div>
            <h2 className="font-heading text-5xl md:text-6xl text-secondary leading-tight mb-8">
              Your Safety, <br />
            ...
            <Link to="/about">
              <Button variant="link" className="p-0 text-primary text-lg font-semibold hover:text-secondary transition-colors">
                Learn about our vision <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </Link>
          </div>
          ...
          <div className="lg:col-span-8 grid gap-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-8">
              <div className="bg-pastelbeige p-10 rounded-sm">
                <Shield className="w-10 h-10 text-primary mb-6" />
                <h3 className="font-heading text-2xl mb-4">Verified Security</h3>
              ...
              <div className="bg-pastelpeach p-10 rounded-sm">
                <Activity className="w-10 h-10 text-primary mb-6" />
                <h3 className="font-heading text-2xl mb-4">Real-time Tracking</h3>
                <p className="text-secondary/80 leading-relaxed">
      ...
      <section className="bg-secondary text-primary-foreground py-32 overflow-hidden">
        <div className="max-w-[120rem] mx-auto px-6 md:px-12 lg:px-20">
          <div className="mb-24 border-b border-primary-foreground/20 pb-8 flex flex-col md:flex-row justify-between items-end gap-8">
            <h2 className="font-heading text-5xl md:text-7xl">The Ecosystem</h2>
            <p className="text-primary-foreground/70 max-w-md text-lg text-right">
      ...
      <section className="py-32 bg-pastelbeige/30">
        <div className="max-w-[120rem] mx-auto px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            {/* Sticky Left Side */}
            <div className="h-fit lg:sticky lg:top-32">
              <h2 className="font-heading text-6xl md:text-7xl text-secondary mb-8">
                How It Works
              </h2>
      ...
      <section className="relative w-full h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-6">
          <div className="max-w-4xl">
            <h2 className="font-heading text-5xl md:text-7xl text-white mb-6 drop-shadow-lg">
              "रक्तदान - जीवनदान"
            </h2>
      ...
      <section className="py-32 bg-background">
        <div className="max-w-[100rem] mx-auto px-6 md:px-12 lg:px-20">
          <div className="bg-secondary rounded-[2rem] p-12 md:p-24 text-center relative overflow-hidden">
            {/* Decorative Circles */}
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Link to="/public-registration">
                  <Button size="lg" className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-white h-16 px-10 text-lg rounded-xl font-semibold shadow-lg shadow-primary/20">
                    Register as Public User
                  </Button>
                </Link>
                <Link to="/hospital-registration">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto border-2 border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground hover:text-secondary h-16 px-10 text-lg rounded-xl font-semibold bg-transparent">
...
function FeatureCard({ icon: Icon, title, desc, bg, index }: { icon: any, title: string, desc: string, bg: string, index: number }) {
  ...
  return (
    <motion.div
      ...
      className={`${bg} group p-10 md:p-14 relative overflow-hidden hover:bg-secondary/95 transition-colors duration-500`}
    >
      <div className="absolute top-6 right-6 opacity-20 group-hover:opacity-100 group-hover:scale-110 transition-all duration-500">
        <Icon className="w-16 h-16 text-primary" />
      </div>
      <div className="relative z-10 h-full flex flex-col justify-between">
        <div>
          <Icon className="w-8 h-8 text-primary mb-6" />
          <h3 className="font-heading text-2xl md:text-3xl mb-4 text-primary-foreground">{title}</h3>
          <p className="text-primary-foreground/60 leading-relaxed">{desc}</p>
        </div>
        <div className="mt-8 pt-8 border-t border-primary-foreground/10 flex items-center text-primary text-sm font-bold tracking-widest uppercase opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">
  ...
  return (
    ...
    >
      <div className="flex items-baseline gap-4 mb-6">
        <span className="font-heading text-6xl text-primary/20 group-hover:text-primary transition-colors duration-500">{number}</span>
        <h3 className="font-heading text-3xl md:text-4xl text-secondary">{title}</h3>
      </div>
      <p className="text-lg text-secondary/70 mb-8 leading-relaxed max-w-xl">
        {desc}
      </p>
